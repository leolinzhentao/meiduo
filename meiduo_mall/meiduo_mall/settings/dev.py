...
SECRET_KEY = 'f)4j@kw9t00xksi1fom)0@(9ub!ladax#k8szc3r8t&x8l&!!&'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://192.168.126.130:6379/0",
        "OPTIONS": {
    ...
    "session": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.126.130:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "verify_codes": {   # 存储短信验证码
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.126.130:6379/2",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "history": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.126.130:6379/3",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "cart": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.126.130:6379/4",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    }
...
EMAIL_PORT = 25
#发送邮件的邮箱
EMAIL_HOST_USER = 'leolinzhentao@163.com'
#在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'linjk123com'
#收件人看到的发件人
EMAIL_FROM = 'meiduo_mall<leolinzhentao@163.com>'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.126.130:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
